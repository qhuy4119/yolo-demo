...
\begin{figure}[t]
	\centering
	\subfloat[\centering The first 10000 max\_batch]{{\includegraphics[width=5cm]{chart.png}}}
	\qquad
	\subfloat[\centering The later 10000 max\_batch]{{\includegraphics[width=5cm]{chart.png}}}
